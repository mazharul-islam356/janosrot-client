  ...
  return (
    <div className="bg-[#f6f1e8]">
      <section className="max-w-7xl mx-auto px-3 lg:px-0 pb-5 pt-3 ">
        <div className="grid grid-cols-1 lg:grid-cols-[0.9fr_1.8fr_1fr] border border-[#cfc7ba] bg-[#ffffff]">
          {/* LEFT CARD */}
            ...
            {leftNews && (
              <Link href={`/news/${leftNews?._id}`}>
                <div className="group">
                  ...
                  {/* META */}
                  <div className="flex items-center gap-3 text-[13px] text-gray-600 mt-2 border-b border-[#cfc7ba] pb-4">
                    <span>Art</span>
                  ...
                  {/* DESCRIPTION */}
                  <p className="mt-2 text-[15px] leading-7 text-[#444] line-clamp-5">
                ...
                <div className="group">
                  ...
                  <div className="mt-4 overflow-hidden">
                    <Image
                      ...
                      width={1200}
                      height={800}
                      className="w-full h-52 md:h-64 object-cover group-hover:scale-[1.02] transition duration-500"
                    />
                  </div>

                  {/* DESCRIPTION */}
                  <div className="pt-5">
                    <p className="text-[15px] text-ellipsis line-clamp-4 leading-7 text-[#444]">
